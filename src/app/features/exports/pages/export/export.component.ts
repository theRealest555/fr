// src/app/features/exports/pages/export/export.component.ts
...
@Component({
  ...
  template: `
    <div class="max-w-4xl mx-auto">
      ...
      <div class="bg-white shadow rounded-lg px-6 py-8 mt-6">
        <h2 class="text-lg font-medium text-gray-900 mb-4">Export Settings</h2>

        <!-- Export Format Options -->
        <div class="mb-6">
          <label class="block text-md font-medium text-gray-900 mb-4">Select Export Format</label>
          <div class="space-y-4">
        ...
        <div class="mb-6">
          <label class="block text-md font-medium text-gray-900 mb-2">Plant</label>
          ...
          <p *ngIf="!isSuperAdmin" class="mt-2 text-sm text-gray-500">
...
export class ExportComponent implements OnInit {
  ...
  onFilterApplied(filters: any): void {
    if (filters.plantId !== undefined) {
      this.selectedPlantId = filters.plantId;
    }
  }
