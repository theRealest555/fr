...
@Component({
  ...
  <div>
    <!-- Welcome Banner -->
    <div class="bg-white dark:bg-dark-800 shadow dark:shadow-dark-md rounded-lg p-4 sm:p-6 mb-6 transition-colors duration-200">
      <div class="flex flex-col md:flex-row md:items-center justify-between">
        <div class="mb-4 md:mb-0">
          <h1 class="text-xl sm:text-2xl font-semibold text-gray-900 dark:text-white">Welcome, {{ currentUser?.fullName }}</h1>
    ...
    <!-- Statistics Cards - Stack on mobile, 3 cards on desktop -->
    ...
    <div class="bg-white dark:bg-dark-800 shadow dark:shadow-dark-md rounded-lg transition-colors duration-200">
      <div class="px-4 sm:px-6 py-5 border-b border-gray-200 dark:border-dark-700 flex justify-between items-center">
              ...
              <div class="flex flex-col sm:flex-row sm:justify-between">
                <div>
                  ...
                  <div class="text-sm text-gray-500 dark:text-gray-400 mt-1 flex items-center flex-wrap">
                    <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-gray-100 dark:bg-dark-700 text-gray-800 dark:text-gray-200 mr-2 mb-1 sm:mb-0">
                      {{ submission.plantName }}
                    </span>
                    <span *ngIf="submission.greyCard" class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-green-100 dark:bg-green-900/30 text-green-800 dark:text-green-400 mb-1 sm:mb-0">
                      Grey Card: {{ submission.greyCard }}
                    </span>
                  </div>
                </div>
                <div class="text-sm text-gray-500 dark:text-gray-400 flex items-center mt-2 sm:mt-0">
    ...
    <!-- Quick Links For Super Admins - Grid layout that adapts to screen size -->
