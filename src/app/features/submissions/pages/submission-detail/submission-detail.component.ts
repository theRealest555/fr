...
@Component({
  ...
  template: `
    <div *ngIf="submission" class="bg-white dark:bg-dark-800 shadow dark:shadow-dark-md rounded-lg transition-colors duration-200">
      ...
      <div class="flex justify-between items-center px-6 py-4 border-b border-gray-200 dark:border-dark-700">
        <div class="flex items-center">
          ...
          <h1 class="text-xl font-semibold text-gray-900 dark:text-white">Submission Details</h1>
        </div>
      ...
      <div class="p-6">
        ...
        <div class="mb-8">
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            <!-- First Name -->
            <div>
              <div class="text-sm font-medium text-gray-500 dark:text-gray-400 mb-1">First Name</div>
              <div class="text-base text-gray-900 dark:text-white">{{ submission.firstName }}</div>
            </div>

            <!-- Last Name -->
            <div>
              <div class="text-sm font-medium text-gray-500 dark:text-gray-400 mb-1">Last Name</div>
              <div class="text-base text-gray-900 dark:text-white">{{ submission.lastName }}</div>
            </div>

            <!-- Gender -->
            <div>
              <div class="text-sm font-medium text-gray-500 dark:text-gray-400 mb-1">Gender</div>
              <div class="text-base text-gray-900 dark:text-white">{{ submission.gender === 0 ? 'Male' : 'Female' }}</div>
            </div>

            <!-- TE ID -->
            <div>
              <div class="text-sm font-medium text-gray-500 dark:text-gray-400 mb-1">TE ID</div>
              <div class="text-base text-gray-900 dark:text-white">{{ submission.teId }}</div>
            </div>

            <!-- CIN -->
            <div>
              <div class="text-sm font-medium text-gray-500 dark:text-gray-400 mb-1">CIN</div>
              <div class="text-base text-gray-900 dark:text-white">{{ submission.cin }}</div>
            </div>

            <!-- Date of Birth -->
            <div>
              <div class="text-sm font-medium text-gray-500 dark:text-gray-400 mb-1">Date of Birth</div>
              <div class="text-base text-gray-900 dark:text-white">{{ formatDate(submission.dateOfBirth) }}</div>
            </div>

            <!-- Plant -->
            <div>
              <div class="text-sm font-medium text-gray-500 dark:text-gray-400 mb-1">Plant</div>
              <div class="text-base text-gray-900 dark:text-white">{{ submission.plantName }}</div>
            </div>

            <!-- Grey Card (if present) -->
            <div *ngIf="submission.greyCard">
              <div class="text-sm font-medium text-gray-500 dark:text-gray-400 mb-1">Grey Card Number</div>
              <div class="text-base text-gray-900 dark:text-white">{{ submission.greyCard }}</div>
            </div>
          </div>
        </div>
        ...
        <!-- Documents Section -->
        <div>
          <h2 class="text-lg font-medium text-gray-900 dark:text-white mb-4">Documents</h2>

          <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
            <!-- CIN Document -->
            <div *ngIf="getCinDocument()" class="border border-gray-200 dark:border-dark-600 rounded-lg overflow-hidden">
              <div class="bg-gray-50 dark:bg-dark-700 px-4 py-2 border-b border-gray-200 dark:border-dark-600">
                <h3 class="text-sm font-medium text-gray-700 dark:text-gray-300">CIN Document</h3>
              </div>
              <div class="p-4">
                <div class="text-sm text-gray-500 dark:text-gray-400 mb-2">Filename: {{ getCinDocument()?.fileName }}</div>
                <div class="text-sm text-gray-500 dark:text-gray-400 mb-4">Uploaded: {{ formatDate(getCinDocument()?.uploadedAt) }}</div>
                <div>
                  <app-button
                    variant="outline"
                    size="sm"
            ...
            <!-- Personal Photo -->
            <div *ngIf="getPersonalPhoto()" class="border border-gray-200 dark:border-dark-600 rounded-lg overflow-hidden">
              <div class="bg-gray-50 dark:bg-dark-700 px-4 py-2 border-b border-gray-200 dark:border-dark-600">
                <h3 class="text-sm font-medium text-gray-700 dark:text-gray-300">Personal Photo</h3>
              </div>
              <div class="p-4">
                <div class="text-sm text-gray-500 dark:text-gray-400 mb-2">Filename: {{ getPersonalPhoto()?.fileName }}</div>
                <div class="text-sm text-gray-500 dark:text-gray-400 mb-4">Uploaded: {{ formatDate(getPersonalPhoto()?.uploadedAt) }}</div>
                <div>
                  <app-button
                    variant="outline"
                    size="sm"
            ...
            <!-- Grey Card (if present) -->
            <div *ngIf="getGreyCardDocument()" class="border border-gray-200 dark:border-dark-600 rounded-lg overflow-hidden">
              <div class="bg-gray-50 dark:bg-dark-700 px-4 py-2 border-b border-gray-200 dark:border-dark-600">
                <h3 class="text-sm font-medium text-gray-700 dark:text-gray-300">Grey Card Document</h3>
              </div>
              <div class="p-4">
                <div class="text-sm text-gray-500 dark:text-gray-400 mb-2">Filename: {{ getGreyCardDocument()?.fileName }}</div>
                <div class="text-sm text-gray-500 dark:text-gray-400 mb-4">Uploaded: {{ formatDate(getGreyCardDocument()?.uploadedAt) }}</div>
                <div>
                  <app-button
                    variant="outline"
                    size="sm"
    ...
    <div *ngIf="error" class="bg-white dark:bg-dark-800 shadow dark:shadow-dark-md rounded-lg p-6 text-center transition-colors duration-200">
      ...
      <h2 class="text-xl font-medium text-gray-900 dark:text-white mb-2">Submission Not Found</h2>
