    ...
    <div class="bg-white dark:bg-dark-800 rounded-lg shadow-lg overflow-hidden">
      ...
      <div class="py-12 px-4 sm:px-6 lg:px-8">
        <div class="max-w-4xl mx-auto">
          <h2 class="text-2xl font-bold text-center text-gray-900 dark:text-white mb-8">How It Works</h2>
      ...
      <!-- CTA Section -->
      <div class="bg-gray-50 dark:bg-dark-900 border-t border-gray-100 dark:border-dark-700 py-12 px-4 sm:px-6 lg:px-8">
        <div class="max-w-3xl mx-auto text-center">
          <h2 class="text-2xl font-bold text-gray-900 dark:text-white mb-4">Ready to submit your documents?</h2>
          <p class="text-gray-600 dark:text-gray-300 mb-6">
            The submission process only takes a few minutes. Make sure you have your ID documents ready.
          </p>
          <div class="flex justify-center">
            <a routerLink="/submission-form" class="inline-flex items-center px-6 py-3 border border-transparent text-base font-medium rounded-md shadow-sm text-white bg-primary-600 hover:bg-primary-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary-500 dark:bg-primary-700 dark:hover:bg-primary-800 transition-colors duration-200">
              Get Started
            </a>
            <a routerLink="/auth/login" class="inline-flex items-center ml-4 px-6 py-3 border border-gray-300 dark:border-gray-600 text-base font-medium rounded-md shadow-sm text-gray-700 dark:text-gray-200 bg-white dark:bg-dark-700 hover:bg-gray-50 dark:hover:bg-dark-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary-500 transition-colors duration-200">
              Administrator Login
            </a>
          </div>
        </div>
