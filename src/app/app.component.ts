// Updated AppComponent with improved responsive layout
...
@Component({
  ...
  <div class="flex-1 flex overflow-hidden">
    ...
    <div *ngIf="sidebarOpen" class="fixed inset-0 z-40 md:hidden">
      <!-- Overlay -->
      <div
        class="fixed inset-0 bg-gray-600 bg-opacity-75 dark:bg-dark-900 dark:bg-opacity-80 backdrop-blur-sm transition-all duration-200"
        (click)="toggleSidebar()"
      ></div>

      <!-- Sidebar -->
      <div class="relative flex-1 flex flex-col max-w-xs w-full bg-gray-800 dark:bg-dark-900 h-full transform transition-transform ease-in-out duration-300 translate-x-0">
...
<div *ngIf="!isLoggedIn" class="h-full flex flex-col">
  ...
  <app-footer></app-footer>
      ...
      <div *ngIf="isLoggedIn" class="min-h-screen flex flex-col">
        <!-- Admin Header -->
        <app-header [sidebarOpen]="sidebarOpen" (toggleSidebar)="toggleSidebar()"></app-header>
        ...
        <div class="flex-1 flex overflow-hidden">
          ...
          <div *ngIf="sidebarOpen"
            ...
            <div class="fixed inset-0 bg-gray-600 bg-opacity-75 dark:bg-dark-900 dark:bg-opacity-80 backdrop-blur-sm transition-all duration-200"></div>
