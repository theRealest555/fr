...
@Component({
  ...
  template: `
    <div class="h-screen flex flex-col bg-gray-50 dark:bg-dark-900 transition-colors duration-200">
      <!-- Global Components -->
          ...
          <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between h-16">
              ...
              <div class="flex-shrink-0 flex items-center">
                ...
                <span class="ml-2 text-lg font-semibold text-gray-900 dark:text-white">TE Connectivity</span>
              </div>
      ...
      <div *ngIf="isLoggedIn" class="h-full flex flex-col">
        ...
        <div class="flex-1 flex overflow-hidden">
          ...
          <div *ngIf="sidebarOpen" class="fixed inset-0 z-40 md:hidden">
            <!-- Overlay -->
            <div class="fixed inset-0 bg-gray-600 bg-opacity-75 dark:bg-dark-900 dark:bg-opacity-80 backdrop-blur-sm transition-all duration-200" (click)="toggleSidebar()"></div>
